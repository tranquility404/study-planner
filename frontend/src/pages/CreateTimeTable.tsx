...
import TimetableLoadingScreen from '../components/TimetableLoadingScreen';
...
export default function CreateTimeTable() {
    ...
    return (
        <>
            {isLoading ? <TimetableLoadingScreen /> : (
                                        ...
                                        {[0, 1, 2].map((step) => (
                                            <div key={step} className="flex items-center">
                                                <button
                                                    ...
                                                    className={`w-8 h-8 rounded-full flex items-center justify-center ${activeSection === step
                                                ...
                                                {step < 2 && (
                                                    <div className={`w-12 h-1 ${activeSection > step ? 'bg-indigo-600' : 'bg-gray-200'
                                                        }`}></div>
                                                )}
                                            </div>
                                        ))}
